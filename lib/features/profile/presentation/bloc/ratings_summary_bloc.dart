...
class RatingsSummaryBloc extends Bloc<RatingsSummaryEvent, RatingsSummaryState> {
  ...
  Future<void> _onRequested(
    ...
    final summary = event.source == RatingsSummarySource.fromDrivers
        ? await _ratingsRepository.getRatingsReceivedFromDrivers()
        : await _ratingsRepository.getRatingsReceivedFromRiders();
    emit(state.copyWith(status: RatingsSummaryStatus.loaded, summary: summary));
  }
}
